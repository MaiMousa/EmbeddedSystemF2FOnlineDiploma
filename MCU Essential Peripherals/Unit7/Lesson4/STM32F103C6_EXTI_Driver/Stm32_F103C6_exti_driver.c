...
void Update_EXTI(EXTI_Pinconfig_t* EXTI_Config)
{
	...
	/* 3. Update rising or falling or both trigger register */
 ...
 * @brief      - This is used to initialize EXTI from specific GPIO pin and specify the mask/trigger
 ...
 * Note        - STM32F103C6 MCU has GPIO A,B,C,D,E modules but LQFP48 package has only GPIO A,B,
               ...
               - Also it is mandatory to enable RCC clock for AFIO and the corresponding GPIO
*/
...
{
	/* Clear the pending register (EXTI_PR): cleared by writing a '1' into the bit */
	EXTI->PR |= (1 << 0);
